...
const categoryIcons: Record<ExpenseCategory, CategoryIconComponent> = {
...
function buildDonutBackground(
  ...
  if (currentPercentage < 100) {
    segments.push(`#e8e1d8 ${currentPercentage}% 100%`)
  }
...
export function Financeiro() {
  ...
  const donutBackground = buildDonutBackground(summary.categories)
    ...
    <main className="finance-page">
      ...
      <section className="finance-overview">
        <article className="finance-summary-card finance-total-card">
          <p className="eyebrow finance-card-title">Total dos gastos</p>
                ...
                summary.categories.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <small>
                        {item.percentage.toFixed(0).replace('.', ',')}%
                      </small>
                    </div>
                  )
                })
